        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    <div class="inner">
                        <h3>{{\App\AdminModel\Archive::max('id')}}</h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        ...
                        <h3>{{count(\App\AdminModel\Archive::where('published_at','>=',\Carbon\Carbon::now())->pluck('id'))}}</h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    <div class="inner">
                        <h3>{{\App\AdminModel\Phonemanage::max('id')}}</h3>
